#!/usr/bin/env python3
"""
Comprehensive Working Estimators Benchmark for LRDBenchmark

This script runs a benchmark with all the estimators that are currently working.
"""
...
class ComprehensiveWorkingEstimatorsBenchmark:
    """
    Comprehensive benchmark including all working estimators.
    """
    ...
    def run_benchmark(self):
        ...
        print("Starting comprehensive benchmark with all working estimators...")
        total_tests = len(self.data_models) * len(self.hurst_values) * len(self.data_lengths) * len(self.contamination_levels) * len(self.estimators) * self.replications
    ...
    def save_results(self, filename_prefix: str = "comprehensive_working_estimators_benchmark"):
...
def main():
    ...
    print("="*60)
    print("LRDBenchmark - Comprehensive Working Estimators Benchmark")
    print("="*60)
    
    # Create and run benchmark
    benchmark = ComprehensiveWorkingEstimatorsBenchmark()
