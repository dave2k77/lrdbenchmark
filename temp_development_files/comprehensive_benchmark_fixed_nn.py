#!/usr/bin/env python3
"""
Comprehensive Benchmark with Fixed Neural Networks
...
On pure synthetic data (FBM, FGN) with proper input shape handling.
"""
...
class ComprehensiveBenchmarkFixedNN:
    """
    Comprehensive benchmark with fixed neural networks for Hurst parameter estimation.
    """
    
    def __init__(self, output_dir: str = "comprehensive_fixed_nn_results"):
    ...
    def run_benchmark(self):
        ...
        logger.info("Starting comprehensive benchmark with fixed neural networks...")
        start_time = time.time()
    ...
    def _save_results(self):
        ...
        results_file = self.output_dir / f"comprehensive_fixed_nn_benchmark_{timestamp}.json"
        with open(results_file, 'w') as f:
            json.dump(self.results, f, indent=2, default=str)
        
        # Save summary
        summary_file = self.output_dir / f"comprehensive_fixed_nn_benchmark_{timestamp}_summary.json"
        with open(summary_file, 'w') as f:
            json.dump(self.summary_df.to_dict('records'), f, indent=2, default=str)
        
        # Save CSV
        csv_file = self.output_dir / f"comprehensive_fixed_nn_benchmark_{timestamp}.csv"
...
def main():
    """Run the comprehensive benchmark."""
    benchmark = ComprehensiveBenchmarkFixedNN()
