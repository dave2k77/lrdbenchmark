...
def generate_training_data(n_samples=1000, length=1024):
    ...
    for _ in range(n_samples):
        ...
        # Initialize model with H
        fbm = FractionalBrownianMotion(H=H)
        
        # Differencing fBm to get fGn-like stationary series
        # Note: generate might take 'rng' or 'random_state' depending on impl.
        # Benchmark usually spawns a generator.
