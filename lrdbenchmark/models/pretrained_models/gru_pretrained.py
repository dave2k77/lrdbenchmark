...
class GRUModel(nn.Module):
    """GRU model for Hurst parameter estimation."""
...
class GRUPretrainedModel(BasePretrainedModel):
    ...
    def _get_default_model_path(self) -> Path:
        ...
        return current_dir.parent.parent / "assets" / "models" / "gru_model.pth"
    ...
    def estimate(self, data: np.ndarray) -> Dict[str, Any]:
        ...
        return {
            ...
            "std_error": 0.05,
            "method": "GRU (Pre-trained Neural Network)",
            "model_info": "PyTorch GRU"
        }
